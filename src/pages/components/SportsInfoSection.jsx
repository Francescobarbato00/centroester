    ...
    <section className="container mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-2 gap-12 bg-white">
      ...
      >
        ...
        <p className="text-gray-600 mt-4 text-lg">
          Scopri le strategie migliori per ottimizzare il tuo allenamento,
          migliorare la tecnica e ottenere il massimo dalle tue prestazioni
          sportive.
        </p>
      ...
      >
        ...
        >
          ...
          <div className="ml-4">
            <h3 className="text-xl font-bold text-black">
              Accesso gratuito a guide di allenamento
            </h3>
            <p className="text-gray-600 mt-1">
              Scarica materiali esclusivi e segui i consigli degli esperti per
        ...
        >
          ...
          <div className="ml-4">
            <h3 className="text-xl font-bold text-black">
              Sconti fino al 30% su attrezzatura sportiva
            </h3>
            <p className="text-gray-600 mt-1">
              Ottieni offerte speciali sui migliori prodotti per il tuo sport
              preferito.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="ml-4">
            ...
            <p className="text-gray-600 mt-1">
              Ricevi assistenza e consigli dagli esperti per il tuo percorso
              sportivo.
            </p>
          </div>
        </motion.div>
