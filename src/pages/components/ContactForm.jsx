...
const ContactForm = () => {
  return (
    <section className="container mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-2 gap-12">
      ...
      >
        <h2 className="text-3xl font-bold">PER INFO</h2>
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p>segreteria@centroester.com</p>
            </div>
          </div>
          <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p>Via Giambattista Vela, 91, 80147 Napoli NA</p>
            </div>
          </div>
        </div>
      </motion.div>
      ...
      <motion.div 
        ...
        transition={{ duration: 0.5 }}
      >
        <h2 className="text-3xl font-bold mb-4">Invia un messaggio</h2>
        <form className="space-y-4">
          ...
          <textarea 
            ...
            className="border border-gray-300 p-3 w-full rounded h-32 focus:outline-none"
          ></textarea>
