  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <h4 className="text-blue-600 font-bold uppercase text-xs md:text-sm tracking-widest">
            Centro Ester
          </h4>
          <h2 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight mt-2">
          ...
          <p className="text-gray-600 mt-4 text-base md:text-lg">
            ...
            numerose attività quali: calcio, tennis, nuoto, fit lab, spinning, hip
            hop, pilates, danza classica e moderna, ginnastica artistica,
          ...
          <p className="text-gray-600 mt-4 text-base md:text-lg">
            ...
            anche presso le istituzioni sportive e civili. Grazie alla
            partecipazione della sua squadra di pallavolo alla Serie A, il Centro
            Ester è riuscito ad attrarre l’attenzione di quotidiani e TV a livello
            nazionale e locale facendo emergere il quartiere di Barra come una
            realtà diversa da quelle solite, legate al degrado delle periferie.
          </p>
          <button className="mt-6 bg-blue-600 text-white font-bold py-2 md:py-3 px-4 md:px-6 rounded-md shadow-md hover:bg-blue-800 transition">
            Scopri di più
          </button>
        </div>
